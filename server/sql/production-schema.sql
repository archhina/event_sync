...
insert into Items (item_id, event_id, user_id, item_name, item_category)
    ...
    (14, 4, 2, "Baklava", "Other"),
    (15, 4, 12, "Tabbouleh Salad", "Side/Appetizer"),
    (16, 5, 8, "Roasted Turkey", "Main Dish"),
    (17, 5, 9, "Stuffing", "Side/Appetizer"),
    (18, 5, 11, "Pumpkin Pie", "Other"),
    (19, 5, 1,"Mashed Potatoes", "Side/Appetizer"),
    (20 ,5 ,3 ,"Green Bean Casserole" ,"Side/Appetizer") ,
    (21 ,6 ,3 ,"Sandwich Platter" ,"Main Dish") ,
    (22 ,6 ,4 ,"Fruit Salad" ,"Side/Appetizer") ,
    (23 ,6 ,5 ,"Chips and Dip" ,"Side/Appetizer") ,
    (24 ,6 ,7 ,"Lemonade" ,"Other") ,
    (25 ,6 ,8 ,"Brownies" ,"Other") ,
    (26 ,7 ,9 ,"BBQ Chicken Skewers" ,"Main Dish") ,
    (27 ,7 ,5 ,"S'mores Kit" ,"Other") ,
    (28 ,7 ,4 ,"Veggie Platter" ,"Side/Appetizer") ,
    (29 ,7 ,12 ,"Potato Chips" ,"Side/Appetizer") ,
    (30 ,7 ,1 ,"Fruit Punch" ,"Other"),
    (31, 1, 1, "Pakora", "Side/Appetizer"),
    (32, 1, 2, "Samosa", "Side/Appetizer"),
    (33, 1, 3, "Chinese & Noodles", "Main Dish"),
    (34, 1, 4, "Rice w/ Meat", "Main Dish"),
    (35, 1, 5, "Sodas", "Other"),
    (36, 1, 6, "Hummus & Pita", "Side/Appetizer"),
    (37, 1, 7, "Mac & Cheese?", "Main Dish"),
    (38, 1, 8, "Donuts", "Other"),
    (39, 1, 9, "Chips & Salsa", "Side/Appetizer"),
    (40, 1, 10, "Sliders", "Main Dish"),
    (41, 1, 11, "Cornbread", "Side/Appetizer"),
    (42, 1, 12, "Bean Dip", "Side/Appetizer");
